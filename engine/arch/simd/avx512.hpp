...
namespace simd {
	...
	ivec dpbusdx2(ivec sum, ivec u0, ivec i0, ivec u1, ivec i1) {
		...
		return _mm512_dpbusd_epi32(_mm512_dpbusd_epi32(sum, u0, i0), u1, i1);
#else
		ivec prod0 = _mm512_maddubs_epi16(u0, i0);
		ivec prod1 = _mm512_maddubs_epi16(u1, i1);
		ivec prod = _mm512_madd_epi16(_mm512_add_epi16(prod0, prod1), _mm512_set1_epi16(1));
